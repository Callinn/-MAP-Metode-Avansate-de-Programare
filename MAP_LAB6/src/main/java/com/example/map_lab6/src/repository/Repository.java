package com.example.map_lab6.src.repository;

import com.example.map_lab6.src.domain.Entity;
import com.example.map_lab6.src.domain.validators.ValidationException;
